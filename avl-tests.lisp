...
(defvar *colors* (text-file->tree "colors.txt"))
(format t "~&~S" *colors*)
...
(format t "~&(serialize-to-file *D* \"d.dat\")")
...
(format t "~&(serialize-to-file *M* \"m.dat\")")
